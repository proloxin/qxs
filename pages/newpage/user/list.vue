	...
	<view>
		<view class="uni-header">
			<view class="uni-group">
				<view class="uni-title">会员列表</view>
		...
		<view class="uni-container">
			<uni-clientdb ref="udb" :collection="collectionName" :options="options" :where="where" field="username,role{role_id,role_name},mobile,nickname,wx_unionid,comment,status,register_date"
...
<script>
	...
	const dbSearchFields = ['mobile',"nickname","wx_unionid"] // 支持模糊搜索的字段列表
	// 分页配置
	const pageSize = 10
	const pageCurrent = 1
